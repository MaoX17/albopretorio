		...
		<div class="col-xs-12 col-sm-12">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<form class="form-horizontal" name='myForm' id='myForm' action="esegui_ricerca_albo.php" method="get">
						...
						<div class="form-group">
							<label for="C_tipo_determina" class="col-sm-2 control-label">Tipo determina:</label>
							<div class="col-sm-10">
								<select class="form-control" name="tipo_determina" id="C_tipo_determina" disabled>
									<option selected="selected" label="Tipo Determina" value="%">Qualsiasi</option>
									<?php
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input class="form-control" value="" type="text" name="autorita" id="C_autorita" size="30" maxlength="250"  />
							</div>
						</div>
						<div class="form-group">
