...
$albo->setIdTipo($_POST['tipo']);
$albo->setIdTipoTrasp($_POST['tipo_trasp']);
$albo->setIdArea($_POST['area']);
(isset($_POST['tipo_determina'])?($albo->setIdTipoDetermina($_POST['tipo_determina'])):"");
$albo->setSpesaPrevista($_POST['spesa_prevista']);
$albo->setNrAtto($_POST['numero']);
$albo->setDtAtto($_POST['dt_atto']);
$albo->setOggetto($_POST['oggetto']);
$albo->setAutoritaEmanante($_POST['autorita']);
$albo->setDtPubblicazDal($_POST['dt_pubbl_dal']);
$albo->setDtPubblicazAl($_POST['dt_pubbl_al']);
...
foreach ($ARRAY_id_file_del as $id_file_da_eliminare) {
	...
	//NOTE: eliminato commento x eliminare file
