...
$albi = AlbiQuery::create()
		->filterByDtPubblicazDal(array("max" => $oggi))
		->filterByDtPubblicazAl(array("min" => $oggi))
			...
			<div class="pagination">
				<ul class='pagination'>
					...
					if ($albi->getPage() == $albi->getLastPage()) {
						...
						echo '<li><a title="Pagina successiva" href = "'.$_SERVER['PHP_SELF'].'?page='.($albi->getPage() + 1).'">&raquo;</a></li>';
					}
					?>
				</ul>
			</div>
